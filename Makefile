...
CFLAGS = ${STACK_FLAGS} -Wall -Iutil -Iatm -Ibank -Irouter -I. -I/usr/include/openssl -lcrypto
...
bin/init : init.c
	${CC} ${CFLAGS} init.c -o bin/init -I/usr/include/openssl -lcrypto
